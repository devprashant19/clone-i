...
export function GlobeComp() {
    ...
    return (
        <div
            className="flex flex-row items-center justify-center py-20 h-screen md:h-auto bg-transparent relative w-full">
            <div
                ...
                <motion.div
                    ...
                    <p
                        ...
                        Our platform bridges distances, enabling seamless communication and collaboration across the globe.
                    </p>
                </motion.div>
